document.addEventListener('DOMContentLoaded', function () {
    ...
    if (iconElement && textElement) {
        if (isAvailable) {
            iconElement.style.backgroundImage = "url('check_24dp_10B981_FILL0_wght400_GRAD0_opsz24.svg')";
            ...
            iconElement.style.backgroundImage = "url('close_20dp_F64749_FILL0_wght400_GRAD0_opsz20.svg')";
            iconElement.style.margin = '5px 0 5px 5px';
